#
#  Be sure to run `pod spec lint ZZAdd.podspec' to ensure this is a
...
# s.screenshots  = "https://github.com/JumpX/ZZArtboardButton/blob/master/images/buttonState.png", "https://github.com/JumpX/ZZArtboardButton/blob/master/images/buttonState1.png"
  ...
  # Or just: s.author    = "Jungle"
  # s.authors            = { "Jungle" => "aosai123007@163.com" }
  # s.social_media_url   = "https://github.com/JumpX"
  ...
  s.source_files  = "Classes", "Classes/**/UIColor+*.{h,m}"
  s.exclude_files = "Classes/Exclude"

  # s.public_header_files = "Classes/**/UIColor+*.h"
