...
- (void)setupDefaults {
    ...
    _indicatorImage = [UIImage imageNamed:@"tabViewBar_indicator_line.pdf"];
...
- (UIImageView *)indicatorView {
    if (!_indicatorView) {
        _indicatorView = [[UIImageView alloc] initWithFrame:CGRectMake(0, self.h-self.indicatorToBottomInterval-self.indicatorHeight, 0, self.indicatorHeight)];
        if (_indicatorImage) {
